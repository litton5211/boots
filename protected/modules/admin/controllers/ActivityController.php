...
class ActivityController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Activity']))
		{
			...
			$model->begin_time=strtotime($_POST['Activity']['begin_time']);
			$model->end_time=strtotime($_POST['Activity']['end_time']);
			if($_FILES['Activity']['error']['pic_url']==0){
				$tmp = $_FILES['Activity']['tmp_name']['pic_url'];
				$file_type =explode('/',$_FILES['Activity']['type']['pic_url']);
				if (sizeof($file_type)>1){
					$type=$file_type[1];
				}
				$pic = "/images/activity/".$dt."_".YII::app()->user->id.".".$type;
